  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        <article>
          {/* HERO */}
          <section className="bg-white border-b border-border pt-10 pb-12 md:pt-14 md:pb-14">
            <div className="container">
              <div className="max-w-3xl">
                ...
                <p className="section-eyebrow">Rotogravura &amp; Flexografia</p>
                <h1 className="text-2xl md:text-4xl font-bold text-foreground leading-tight mb-4">
                  Como funciona o revestimento de cilindros para rotogravura e
                  flexografia
                </h1>
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-6 border-t border-border">
                  ...
                  <span className="text-sm text-muted-foreground">
                    +40 anos de profissão · 100% controle de qualidade · Atendimento
                    técnico em SP
                  </span>
                </div>
              </div>
